...
import type { CodeSnippet as _CodeSnippet, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteCode(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCode(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listLanguages(): Promise<Array<LanguageSummary>> {
        if (this.processError) {
            try {
                const result = await this.actor.listLanguages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async loadCode(arg0: string): Promise<CodeSnippet | null> {
        if (this.processError) {
            try {
                const result = await this.actor.loadCode(arg0);
    ...
    async saveCode(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCode(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CodeSnippet]): CodeSnippet | null {
